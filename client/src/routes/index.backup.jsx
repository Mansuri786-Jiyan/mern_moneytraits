...
function AppRoutes() {
    ...
    return (_jsx(BrowserRouter, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/landing", element: _jsx(LandingPage, {}) }), _jsx(Route, { path: "/", element: _jsx(AuthRoute, {}), children: _jsx(Route, { element: _jsx(BaseLayout, {}), children: authenticationRoutePaths.map((route) => (_jsx(Route, { path: route.path, element: route.element }, route.path))) }) }), _jsx(Route, { element: _jsx(ProtectedRoute, {}), children: _jsx(Route, { element: _jsx(AppLayout, {}), children: protectedRoutePaths.map((route) => {
                                if (route.adminOnly) {
