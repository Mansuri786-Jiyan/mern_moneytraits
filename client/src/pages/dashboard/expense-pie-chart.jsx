...
const ExpensePieChart = (props) => {
    ...
    return (_jsxs(Card, { className: "!shadow-none border-1 border-gray-100 dark:border-border", children: [_jsxs(CardHeader, { className: "pb-2", children: [_jsx(CardTitle, { className: "text-lg", children: "Expenses Breakdown" }), _jsxs(CardDescription, { children: ["Total expenses ", dateRange?.label] })] }), _jsx(CardContent, { className: "h-[313px]", children: _jsx("div", { className: " w-full", children: categories?.length === 0 ? (_jsx(EmptyState, { title: "No expenses found", description: "There are no expenses recorded for this period." })) : (_jsx(ChartContainer, { config: chartConfig, className: "mx-auto aspect-square h-[300px]", children: _jsxs(PieChart, { children: [_jsx(ChartTooltip, { cursor: false, content: _jsx(ChartTooltipContent, {}) }), _jsxs(Pie, { data: categories, dataKey: "value", nameKey: "name", innerRadius: 60, outerRadius: 80, paddingAngle: 2, strokeWidth: 2, stroke: "#fff", children: [categories.map((_, index) => (_jsx(Cell, { fill: COLORS[index % COLORS.length] }, `cell-${index}`))), _jsx(Label, { content: ({ viewBox }) => {
