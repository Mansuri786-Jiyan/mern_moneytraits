...
const SummaryCard = ({ title, value, isCurrency = true, isDestructive = false }) => (
  <Card className="!border-none !border-0 !gap-0 !bg-white/5">
    ...
    <CardContent className="space-y-1">
      <div className={cn("text-3xl font-bold text-white", isDestructive && "text-red-400")}>
...
const BudgetSummaryBar = ({ summary, isLoading }) => {
  ...
  const { totalBudgeted, totalSpent, totalRemaining, budgetsOverLimit } = summary;
