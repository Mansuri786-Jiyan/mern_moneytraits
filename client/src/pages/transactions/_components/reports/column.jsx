  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const statusStyles = {
        ...
        [_REPORT_STATUS.PROCESSING]:
          "bg-blue-100 text-blue-700 border-blue-200",
        [_REPORT_STATUS.NO_ACTIVITY]:
      ...
      return (
        <span
          className={`inline-flex items-center rounded-lg border px-2.5 py-0.5 text-[10px] font-black uppercase tracking-wider ${style}`}
        >
          {status}
        </span>
      );
