...
export const apiClient = createApi({
    ...
    tagTypes: ["transactions", "analytics", "billingSubscription", "users", "budgets", "forecast", "reports", "Goals", "admin-stats", "admin-transactions", "categories"], // Tag types for RTK Query
