...
const TransactionTable = (props) => {
    ...
    return (_jsx(DataTable, { data: transactions, columns: transactionColumns, searchPlaceholder: "Search transactions...", isLoading: isFetching, isBulkDeleting: isBulkDeleting, isShowPagination: props.isShowPagination, pagination: pagination, filters: [
            {
                key: "type",
                label: "All Types",
                options: [
        ...
        ], onSearch: handleSearch, onPageChange: (pageNumber) => handlePageChange(pageNumber), onPageSizeChange: (pageSize) => handlePageSizeChange(pageSize), onFilterChange: (filters) => handleFilterChange(filters), onBulkDelete: handleBulkDelete }));
};
