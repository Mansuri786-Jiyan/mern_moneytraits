export const getEmailVerificationTemplate = (username, otp) => {
           ...
           <table cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
             ...
             <tr>
               <td style="padding: 30px; text-align: center;">
                 ...
                 <p style="margin: 0 0 20px; font-size: 16px; text-align: left;">
                   Welcome to Moneytraits! Please verify your email address by entering the OTP below:
                 </p>
                 ...
                 <p style="margin: 20px 0 0; font-size: 14px; color: #666; text-align: left;">
                   This OTP expires in 15 minutes. If you did not create an account, please ignore this email.
                 </p>
               </td>
             </tr>
             <tr>
