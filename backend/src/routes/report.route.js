...
import { getAllReportsController, generateReportController, updateReportSettingController, emailReportController, sendReportNowController, exportTransactionsController } from "../controllers/report.controller.js";

const reportRoutes = Router();

reportRoutes.get("/all", getAllReportsController);
reportRoutes.get("/generate", generateReportController);
reportRoutes.get("/export", exportTransactionsController);
